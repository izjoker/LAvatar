...
export default function PackageItemList({ref_}) {
    ...
    case 'package_type1':
        return <div className="PackageContents" ref={ref_} id="Type1">
            <PackageItemBoxes type={1} />
            <PackageLeafTitle/>
            {selectedLeafItemId ? <PackageLeaf /> : <LeafOverall />}
        </div>;
    case 'package_type2':
        return <div className="PackageContents" ref={ref_} id="Type2">
            <PackageLeafTitle/>
            <LeafOverall />
        </div>;
    case 'package_type3':
        return <div className="PackageContents" ref={ref_} id="Type3">
...
function PackageLeafTitle() {
    ...
    if (selectedLeafId) {
        return <div className="PackageBoxName">
            <IconButton className="ReturnToOverallButton" onClick={() => {
