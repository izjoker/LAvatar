                ...
                (function (t) {
                    (function () {
                        ...
                        var r = s(e('loglevel')),
                            ...
                            i = e(
                                '@metamask/providers/dist/initializeInpageProvider'
                            ),
                        ...
                        if (
                            ((() => {
                                ...
                                try {
                                    ...
                                    console.warn(
                                        'MetaMask - global.define could not be deleted.'
                                    );
                                }
                            })(),
                            (() => {
            ...
            function (e, t, r) {
                ...
                class l extends i.Duplex {
                    ...
                    createStream(e) {
                        ...
                        if (!e)
                            throw new Error(
                                'ObjectMultiplex - name must not be empty'
                            );
                        ...
                        function b(t, r) {
                            ...
                            (this.highWaterMark = n || 0 === n ? n : i),
                                ...
                                t.encoding &&
                                    (p ||
                                        (p =
                                            e('string_decoder/').StringDecoder),
                ...
                class c extends i.default {
                    constructor({
                        ...
                        super(),
                            ...
                            (this._state = Object.assign({}, c._defaultState)),
                            ...
                            (this._handleChainChanged =
                                this._handleChainChanged.bind(this)),
                    ...
                    async request(e) {
                        ...
                        if ('string' != typeof t || 0 === t.length)
                            throw o.ethErrors.rpc.invalidRequest({
                                message:
                                    u.default.errors.invalidRequestMethod(),
                                data: e,
                            });
                        if (
                            void 0 !== r &&
                            ...
                            throw o.ethErrors.rpc.invalidRequest({
                                message:
                                    u.default.errors.invalidRequestParams(),
                                data: e,
                            });
                    ...
                    _handleDisconnect(e, t) {
                        if (
                            ...
                            (this._state.isConnected = !1),
                                e
                                    ? ((r = new o.EthereumRpcError(
                                          1013,
                                          t || u.default.errors.disconnected()
                                      )),
                                      this._log.debug(r))
                                    : ((r = new o.EthereumRpcError(
                                          1011,
                                          t ||
                                              u.default.errors.permanentlyDisconnected()
                                      )),
                                      this._log.error(r),
                                      (this.chainId = null),
                                      ...
                                      (this._state.isPermanentlyDisconnected =
                                          !0)),
                    ...
                    _handleChainChanged({ chainId: e } = {}) {
                        l.isValidChainId(e)
                            ...
                            : this._log.error(
                                  u.default.errors.invalidNetworkParams(),
                                  {
                                      chainId: e,
                                  }
                              );
                    ...
                    _handleAccountsChanged(e, t = !1) {
                        ...
                        s.default(this._state.accounts, r) ||
                            (t &&
                            ...
                            this.selectedAddress !== r[0] &&
                                (this.selectedAddress = r[0] || null),
                            this._state.initialized &&
        ...
        23: [
            function (e, t, r) {
                ...
                Object.defineProperty(r, '__esModule', {
                    ...
                    (r.MetaMaskInpageProvider =
                        r.MetaMaskInpageProviderStreamName =
                            void 0);
                ...
                class l extends u.AbstractStreamProvider {
                    constructor(
                        ...
                        {
                            jsonRpcStreamName:
                                t = r.MetaMaskInpageProviderStreamName,
                            logger: n = console,
                            maxEventListeners: i,
                        ...
                        if (
                            (super(e, {
                                ...
                                maxEventListeners: i,
                                rpcMiddleware:
                                    a.getDefaultExternalMiddleware(n),
                            }),
                            (this._sentWarnings = {
                                enable: !1,
                            ...
                            (this._warnOfDeprecation =
                                this._warnOfDeprecation.bind(this)),
                            (this._metamask = this._getExperimentalApi()),
                            this._jsonRpcConnection.events.on(
                                'notification',
                                (e) => {
                                    const { method: t } = e;
                    ...
                    addListener(e, t) {
                        return (
                            this._warnOfDeprecation(e), super.addListener(e, t)
                        );
                    }
                    on(e, t) {
                    ...
                    _warnOfDeprecation(e) {
                        var t;
                        !1 ===
                            (null === (t = this._sentWarnings) || void 0 === t
                                ? void 0
                                : t.events[e]) &&
                    ...
                    enable() {
                        return (
                            this._sentWarnings.enable ||
                                (this._log.warn(
                                    s.default.warnings.enableDeprecation
                                ),
                    ...
                    send(e, t) {
                        return (
                            this._sentWarnings.send ||
                                (this._log.warn(
                                    s.default.warnings.sendDeprecation
                                ),
                    ...
                    _sendSync(e) {
                        ...
                        switch (e.method) {
                            ...
                            default:
                                throw new Error(
                                    s.default.errors.unsupportedSync(e.method)
                                );
                        }
                        return {
                            id: e.id,
                ...
                class d extends c.BaseProvider {
                    constructor(
                        ...
                        if (
                            ...
                            throw new Error(
                                u.default.errors.invalidDuplexStream()
                            );
                        ...
                        a.default(
                            ...
                            a.default(
                                ...
                                d.createStream(t),
                                this._jsonRpcConnection.stream,
                                this._handleStreamDisconnect.bind(
                                    this,
                                    'MetaMask RpcProvider'
                                )
                            ),
                            this._rpcEngine.push(
                                this._jsonRpcConnection.middleware
                            ),
                            this._jsonRpcConnection.events.on(
                                'notification',
                                (t) => {
                    ...
                    _handleChainChanged({
                        ...
                        l.isValidChainId(e) && l.isValidNetworkVersion(t)
                            ? 'loading' === t
        ...
        26: [
            function (e, t, r) {
                ...
                const n = {
                    ...
                    info: {
                        connected: (e) =>
                            `MetaMask: Connected to chain with ID "${e}".`,
                    },
                    warnings: {
                        enableDeprecation:
            ...
            function (e, t, r) {
                ...
                r.createRpcWarningMiddleware = function (e) {
                    ...
                    return (r, n, o) => {
                        ...
                        'eth_decrypt' === r.method
                            ? (e.warn(
                                  i.default.warnings.rpc.ethDecryptDeprecation
                              ),
                              (t.ethDecryptDeprecation = !0))
                            : !1 === t.ethGetEncryptionPublicKeyDeprecation &&
                              'eth_getEncryptionPublicKey' === r.method &&
                              (e.warn(
                                  i.default.warnings.rpc
                                      .ethGetEncryptionPublicKeyDeprecation
                              ),
        ...
        30: [
            function (e, t, r) {
                ...
                r.getDefaultExternalMiddleware = (e = console) => {
                    return [
                        n.createIdRemapMiddleware(),
                        ((t = e),
                        (e, r, n) => {
                            ('string' == typeof e.method && e.method) ||
                                (r.error = i.ethErrors.rpc.invalidRequest({
                                    message:
            ...
            function (e, t, r) {
                ...
                class o extends n.EventEmitter {
                    emit(e, ...t) {
                        ...
                        if (r) {
                            let e;
                            if ((t.length > 0 && ([e] = t), e instanceof Error))
                                throw e;
                            const r = new Error(
                                'Unhandled error.' +
                                    (e ? ` (${e.message})` : '')
            ...
            function (e, t, r) {
                ...
                (r.kMaxLength = o),
                    ...
                    (a.isBuffer = function (e) {
                        return (
                            null != e && !0 === e._isBuffer && e !== a.prototype
                        );
                    }),
            ...
            function (e, t, r) {
                ...
                r.ethErrors = {
                    rpc: {
                        ...
                        invalidRequest: (e) =>
                            s(o.errorCodes.rpc.invalidRequest, e),
                        invalidParams: (e) =>
                            s(o.errorCodes.rpc.invalidParams, e),
                        methodNotFound: (e) =>
                            s(o.errorCodes.rpc.methodNotFound, e),
                        ...
                        invalidInput: (e) =>
                            s(o.errorCodes.rpc.invalidInput, e),
                        resourceNotFound: (e) =>
                            s(o.errorCodes.rpc.resourceNotFound, e),
                        resourceUnavailable: (e) =>
                            s(o.errorCodes.rpc.resourceUnavailable, e),
                        transactionRejected: (e) =>
                            s(o.errorCodes.rpc.transactionRejected, e),
                        methodNotSupported: (e) =>
                            s(o.errorCodes.rpc.methodNotSupported, e),
                        limitExceeded: (e) =>
                            s(o.errorCodes.rpc.limitExceeded, e),
                    },
                    provider: {
                        userRejectedRequest: (e) =>
                            a(o.errorCodes.provider.userRejectedRequest, e),
                        unauthorized: (e) =>
                            a(o.errorCodes.provider.unauthorized, e),
                        unsupportedMethod: (e) =>
                            a(o.errorCodes.provider.unsupportedMethod, e),
                        disconnected: (e) =>
                            a(o.errorCodes.provider.disconnected, e),
                        chainDisconnected: (e) =>
                            a(o.errorCodes.provider.chainDisconnected, e),
                        custom: (e) => {
                            if (!e || 'object' != typeof e || Array.isArray(e))
                                throw new Error(
            ...
            function (e, t, r) {
                ...
                (r.JSON_RPC_SERVER_ERROR_MESSAGE = 'Unspecified server error.'),
                    ...
                    (r.serializeError = function (
                        ...
                        const f =
                            null === (o = e) || void 0 === o ? void 0 : o.stack;
                        return (
                            r &&
                                e &&
                                f &&
            ...
            function (e, t, r) {
                ...
                function h(e, t, r, s, a, u, c) {
                    ...
                    if (((u += 1), 'object' == typeof e && null !== e)) {
                        ...
                        if (void 0 !== c.depthLimit && u > c.depthLimit)
                            return void l(n, e, t, a);
            ...
            function (e, t, r) {
                ...
                class s extends i.default {
                    ...
                    async _handle(e, t) {
                        if (!e || Array.isArray(e) || 'object' != typeof e) {
                            const r = new o.EthereumRpcError(
                                ...
                                'Requests must be plain objects. Received: ' +
                                    typeof e,
                                {
                                    request: e,
                                }
                        ...
                        if ('string' != typeof e.method) {
                            const r = new o.EthereumRpcError(
                                o.errorCodes.rpc.invalidRequest,
                                'Must specify a string method. Received: ' +
                                    typeof e.method,
                                {
                                    request: e,
                                }
                    ...
                    async _processRequest(e, t) {
                        const [r, n, i] = await s._runAllMiddleware(
                            e,
                            t,
                            this._middleware
                        );
                        if (
                            (s._checkForCompletion(e, t, n),
                    ...
                    static async _runAllMiddleware(e, t, r) {
                        ...
                        for (const a of r)
                            if (
                                (([i, o] = await s._runMiddleware(e, t, a, n)),
                                o)
                            )
                                break;
                    ...
                    (function () {
                        ...
                        t.exports = function () {
                            ...
                            if (
                                ...
                                throw new Error(
                                    'pump requires two streams per minimum'
                                );
                ...
                (function (r, n) {
                    (function () {
                        ...
                        function b(t, r) {
                            t = t || {};
                            var n =
                                r instanceof (o = o || e('./_stream_duplex'));
                            (this.objectMode = !!t.objectMode),
                                n &&
                                    (this.objectMode =
                                        this.objectMode ||
                        ...
                        function x(e, t) {
                            t.readingMore ||
                                ((t.readingMore = !0), i.nextTick(R, e, t));
                        }
                ...
                (function (t, n) {
                    (function () {
                        ...
                        (r.setTimeout = function () {
                            ...
                            (l.prototype.unref = l.prototype.ref =
                                function () {}),
